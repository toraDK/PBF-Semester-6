...
![alt text](../jobsheet12/gambar_dokumentasi/1.png)<br><br>

Bagian 2 – Pengujian ISR<br>
build <br>
![alt text](../jobsheet12/gambar_dokumentasi/2.png)<br>
Hasil Awal<br>
![alt text](../jobsheet12/gambar_dokumentasi/3.png)<br>
Data pada firestore sebelum ada data baru<br>
![alt text](../jobsheet12/gambar_dokumentasi/4.png)<br>
tambah data baru di firestore<br>
![alt text](../jobsheet12/gambar_dokumentasi/5.png)<br>
Hasil tampilan website setelah 10 detik<br>
![alt text](../jobsheet12/gambar_dokumentasi/6.png)<br><br>

#### On-Demand Revalidation
Bagian 1 – Buat API Revalidate<br>
![alt text](../jobsheet12/gambar_dokumentasi/7.png)<br><br>

Bagian 2 – Tambahkan Parameter Data<br>
![alt text](../jobsheet12/gambar_dokumentasi/8.png)<br>
Hasil url http://localhost:3000/api/revalidate?data=produk<br>
![alt text](../jobsheet12/gambar_dokumentasi/9.png)<br>
hadil url http://localhost:3000/api/revalidate?data=<br>
![alt text](../jobsheet12/gambar_dokumentasi/10.png)<br><br>

Bagian 3 – Tambahkan Token Security<br>
Menambahkan token revalidate ke file .env<br>
![alt text](../jobsheet12/gambar_dokumentasi/11.png)<br>
edit kde revalidate<br>
![alt text](../jobsheet12/gambar_dokumentasi/12.png)<br><br>

E. Pengujian Manual Revalidation<br>
Hasil jika memasukkan parameter token dengan benar di url<br>
![alt text](../jobsheet12/gambar_dokumentasi/13.png)<br>
Hasil jika memasukkan parameter token yang salah di url<br>
![alt text](../jobsheet12/gambar_dokumentasi/14.png)<br>
Hasil jika tanpa memasukkan parameter token di url<br>
![alt text](../jobsheet12/gambar_dokumentasi/15.png)<br><br>

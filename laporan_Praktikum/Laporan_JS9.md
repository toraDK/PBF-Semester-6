...
![alt text](../jobsheet9/gambar_dokumentasi/1.png)<br>
Hasil :<br>
![alt text](../jobsheet9/gambar_dokumentasi/2.png)<br><br>

Bagian 2 – Implementasi getServerSideProps pada server.tsx<br>
![alt text](../jobsheet9/gambar_dokumentasi/3.png)<br>
Hasil :<br>
![alt text](../jobsheet9/gambar_dokumentasi/4.png)<br><br>

Bagian 3 – Refactor Type ( produk type )<br>
![alt text](../jobsheet9/gambar_dokumentasi/5.png)<br>
![alt text](../jobsheet9/gambar_dokumentasi/6.png)<br>
Hasil :<br>
![alt text](../jobsheet9/gambar_dokumentasi/7.png)<br><br>

Bagian 4 – Uji Perbedaan SSR vs CSR<br>
Uji 1 – Skeleton<br>
-> Hasil CSR<br>
![alt text](../jobsheet9/gambar_dokumentasi/8.png)<br>
muncul sekeleton terlebih dahulu sebelum muncul data<br>

-> Hasil SSR<br>
![alt text](../jobsheet9/gambar_dokumentasi/9.png)<br>
tidak muncul sekeleton sebelum muncul data<br>

Uji 2 – Network Tab<br>
-> Hasil CSR<br>
![alt text](../jobsheet9/gambar_dokumentasi/10.png)<br>

-> Hasil SSR<br>
![alt text](../jobsheet9/gambar_dokumentasi/11.png)<br>
...
1. Buat 2 halaman:<br>
    - /products (CSR)<br>
    ![alt text](../jobsheet9/gambar_dokumentasi/13.png)<br>
    - /products/server (SSR)<br>
    ![alt text](../jobsheet9/gambar_dokumentasi/12.png)<br>

2. Dokumentasikan:<br>
    - Screenshot CSR<br>
    ![alt text](../jobsheet9/gambar_dokumentasi/14.png)<br>
    Hasil :<br>
    ![alt text](../jobsheet9/gambar_dokumentasi/13.png)<br>
    - Screenshot SSR<br>
    ![alt text](../jobsheet9/gambar_dokumentasi/15.png)<br>
    Hasil :<br>
    ![alt text](../jobsheet9/gambar_dokumentasi/12.png)<br>
    ...
    -> Hasil CSR<br>
    ![alt text](../jobsheet9/gambar_dokumentasi/16.png)<br>
    -> Hasil SSR<br>
    ![alt text](../jobsheet9/gambar_dokumentasi/17.png)<br>

...
![alt text](../jobsheet14/gambar_dokumentasi/1.png)<br><br>

Bagian 2 – Konfigurasi API Auth\<br>
membuat file [...nextauth].tsx<br>
![alt text](../jobsheet14/gambar_dokumentasi/2.png)<br>
Modifikasi file [...nextauth].tsx<br>
![alt text](../jobsheet14/gambar_dokumentasi/3.png)<br><br>

Bagian 3 – Tambahkan Secret<br>
Generate nilai random base64<br>
![alt text](../jobsheet14/gambar_dokumentasi/4.png)<br>
copy hasil generate nilai random base64 ke file .env<br>
![alt text](../jobsheet14/gambar_dokumentasi/5.png)<br><br>

Bagian 4 – Tambahkan SessionProvider<br>
memodifikasi file _app.tsx<br>
![alt text](../jobsheet14/gambar_dokumentasi/6.png)<br><br>

Bagian 5 – Tambahkan Tombol Login & Logout<br>
Edit file index.tsx pada folder component/navbar<br>
![alt text](../jobsheet14/gambar_dokumentasi/7.png)<br>
edit file navbar.module.css<br>
![alt text](../jobsheet14/gambar_dokumentasi/8.png)<br>
Hasil :<br>
![alt](../jobsheet14/gambar_dokumentasi/Hasilnext-authCredentials.gif)<br>
edit file index.tsx untuk mendapatkan session nya<br>
![alt text](../jobsheet14/gambar_dokumentasi/9.png)<br>
Hasil :<br>
![alt](../jobsheet14/gambar_dokumentasi/Hasilnext-authCredentials2.gif)<br><br>

Langkah 6 – Menambahkan Data Tambahan (Full Name)<br>
Edit kode pada file [...nextauth].ts<br>
![alt text](../jobsheet14/gambar_dokumentasi/10.png)<br>
![alt text](../jobsheet14/gambar_dokumentasi/11.png)<br>
Modifikasi style navbar<br>
![alt text](../jobsheet14/gambar_dokumentasi/12.png)<br>
Modifikasi component navbar<br>
![alt text](../jobsheet14/gambar_dokumentasi/13.png)<br>
Hasil :<br>
![alt](../jobsheet14/gambar_dokumentasi/Hasilnext-authCredentials3.gif)<br><br>

##### Proteksi Halaman Profile
Langkah 7 – Buat Halaman Profile<br>
file profile/index.tsx<br>
![alt text](../jobsheet14/gambar_dokumentasi/14.png)<br>
Hasil :<br>
![alt text](../jobsheet14/gambar_dokumentasi/15.png)<br><br>

Langkah 8 – Buat Middleware Authorization<br>
Isi file baru withAuth.ts<br>
![alt text](../jobsheet14/gambar_dokumentasi/16.png)<br>
Perubahan kode pada middleware.ts<br>
![alt text](../jobsheet14/gambar_dokumentasi/17.png)<br><br>

Pengujian <br>
Uji 1 – Belum Login<br>
![alt](../jobsheet14/gambar_dokumentasi/belumLogin.gif)<br>

Uji 2 – Sudah Login<br>
![alt](../jobsheet14/gambar_dokumentasi/Login.gif)<br>

Uji 3 – Logout<br>
![alt](../jobsheet14/gambar_dokumentasi/logout.gif)<br><br>

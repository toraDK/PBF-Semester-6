...
![alt text](../jobsheet18/gambar_dokumentasi/1.png)<br>
Mengganti tag <img> pada halaman 404<br>
![alt text](../jobsheet18/gambar_dokumentasi/2.png)<br>
Hasil perfoma page 404 di lighthouse setelah memakai tag Image<br>
![alt text](../jobsheet18/gambar_dokumentasi/3.png)<br><br>

#### Optimasi Gambar Remote (External URL)
edit tag imag di file views/product/index.tsx
![alt text](../jobsheet18/gambar_dokumentasi/4.png)<br>
Buka file next.config.js<br>
![alt text](../jobsheet18/gambar_dokumentasi/5.png)<br><br>

Hasil :<br>
tanpa tag Image<br>
![alt text](../jobsheet18/gambar_dokumentasi/6.png)<br>
Saat memakai tag Image<br>
![alt text](../jobsheet18/gambar_dokumentasi/7.png)<br><br>

### PRAKTIKUM 2 – Font Optimization
#### Menggunakan next/font
modifikasi file index.tsx pada folder Appshell/index.tsx<br>
![alt text](../jobsheet18/gambar_dokumentasi/8.png)<br>
Hasil :<br>
![alt text](../jobsheet18/gambar_dokumentasi/9.png)<br><br>

### PRAKTIKUM 3 – Script Optimization
#### Menggunakan next/script
modifikasi file index.tsx pada folder layouts/Navbar<br>
![alt text](../jobsheet18/gambar_dokumentasi/10.png)<br><br>

### PRAKTIKUM 4 – Optimasi Avatar dengan next/image
modifikasi file index.tsx pada folder layouts/navbar<br>
![alt text](../jobsheet18/gambar_dokumentasi/11.png)<br>
menambaahkan konfigurasi untuk url google di next.config.ts agar data gambar bisa dipakai di aplikasi<br>
![alt text](../jobsheet18/gambar_dokumentasi/12.png)<br>
Hasil :<br>
![alt text](../jobsheet18/gambar_dokumentasi/13.png)<br>

Tugas<br>
1. Optimasi semua image di project menggunakan next/image<br>
![alt text](../jobsheet18/gambar_dokumentasi/14.png)<br>
Hasil :<br>
![alt text](../jobsheet18/gambar_dokumentasi/15.png)<br>
2. Gunakan minimal 1 font dari next/font<br>
![alt text](../jobsheet18/gambar_dokumentasi/16.png)<br>
menggunakan font roboto<br>
3. Tambahkan script Google Analytics menggunakan next/script<br>
![alt text](../jobsheet18/gambar_dokumentasi/17.png)<br>
4. Terapkan dynamic import pada minimal 1 komponen<br>
![alt text](../jobsheet18/gambar_dokumentasi/18.png)<br>
5. Dokumentasikan perubahan performa (screenshot Lighthouse)<br>
![alt text](../jobsheet18/gambar_dokumentasi/19.png)<br>
